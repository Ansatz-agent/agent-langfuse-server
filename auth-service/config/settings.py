...
SESSION_COOKIE_NAME = os.getenv("SESSION_COOKIE_NAME", "__Host-ansatz_sessionid")
SESSION_COOKIE_PATH = "/"
SESSION_COOKIE_DOMAIN = None
CSRF_COOKIE_SAMESITE = "Lax"
CSRF_COOKIE_NAME = os.getenv("CSRF_COOKIE_NAME", "__Host-ansatz_csrftoken")
CSRF_COOKIE_PATH = "/"
...
MEMORY_INTERNAL_TOKEN = os.getenv("MEMORY_INTERNAL_TOKEN", "").strip()
